...
const ConfigLogController = require("../../modules/configLogs/controller");
...
router.post("/add", ConfigLogController.addConfigLog);
...
router.get("/", ConfigLogController.getConfigLog);
